			...
			'tempo-faq' => array(
			    ...
			    'sections' 	=> array(
				    ...
				    'child-themes'	=> array(
						...
						'description'	=> sprintf( __( 'Here you can explore the Tempo child themes compatible with %1s.', 'tempo' ), '<a href="' . esc_url( tempo_core::zeon( 'uri-childs' ) ) . '" title="' . esc_attr( tempo_core::zeon( 'description' ) )  . '" target="_blank">' . __( 'Zeon Premium WordPress Plugin', 'tempo' ) . '</a>' ),
					...
					'zeon' => array(
						...
						'description'	=> sprintf( __( 'Activate premium features and get extended core functionality without the risk of loosing any data or settings %1s with our %2s that upgrades our Tempo free and Tempo Child themes.', 'tempo' ) , '<br/>', '<a href="' . esc_url( tempo_core::zeon( 'uri-description' ) ) . '" title="' . esc_attr( tempo_core::zeon( 'description' ) )  . '" target="_blank">' . __( 'Zeon Premium WordPress Plugin', 'tempo' ) . '</a>' ),
