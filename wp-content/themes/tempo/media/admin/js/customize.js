...
(function($){
    ...
    {   //- HEADER -//
        ...
        {   //- GENERAL -//
            wp.customize( 'header-height' , function( value ){
                value.bind(function( newval ){
                    jQuery( 'div.tempo-header-partial' ).css( 'height' , parseInt( newval ).toString() + 'px' );
                });
            });
            ...
            wp.customize( 'header-mask-color' , function( value ){
                value.bind(function( newval ){
                    ...
                    jQuery( 'div.tempo-header-partial div.tempo-header-mask' ).css({ 'background-color' : rgba });
                });
            });
    ...
    {   //- BREADCRUMBS -//
        ...
        wp.customize( 'breadcrumbs-space' , function( value ){
            value.bind(function( newval ){
            	jQuery( 'div.tempo-breadcrumbs div.tempo-container.main' ).css({ 'padding-top' : parseInt( newval ) + 'px' });
                jQuery( 'div.tempo-breadcrumbs div.tempo-container.main' ).css({ 'padding-bottom' : parseInt( newval ) + 'px' });
            });
        });
    }
