    ...
    if( !class_exists( 'tempo_page' ) ){
        class tempo_page
        {
            ...
            public function header()
            {
                ...
                $rett .= '<h1 class="tempo-brand"><a href="' . esc_url( tempo_core::author( 'uri-title' ) ) . '" title="' . esc_attr( tempo_core::author( 'name' ) .' - ' . tempo_core::author( 'description' ) ) . '">' . tempo_core::author( 'name' ) . '</a></h1>';
                $rett .= '</div>';
                ...
                $rett .= '<li>';
                $rett .= '<a href="' . esc_url( tempo_core::author( 'contact' ) ) .'">' . __( 'Contact US', 'tempo' ) . '</a>';
                $rett .= '</li>';
                $rett .= '</ul>';
                ...
                $rett .= '<a href="' . esc_url( tempo_core::author( 'uri-description' ) ) . '" target="_blank">' . tempo_core::author( 'description' ) . '</a>';
                $rett .= '</span>';
                $rett .= '<a href="' . esc_url( tempo_core::theme( 'uri-version' ) ) . '" target="_blank">' . sprintf( __( '%s - free version ( %s )', 'tempo' ), '<strong>' . tempo_core::theme( 'Name' ) . '</strong>',  tempo_core::theme( 'Version' ) ) . '</a>';
                $rett .= '</div>';
