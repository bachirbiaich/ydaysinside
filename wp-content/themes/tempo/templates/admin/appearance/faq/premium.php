<a href="<?php echo esc_attr( tempo_core::zeon( 'uri-image' ) ); ?>" class="zeon-image" target="_blank" title="<?php echo esc_attr( tempo_core::zeon( 'description' ) ); ?>">
	<img src="<?php echo esc_url( get_template_directory_uri() . '/media/admin/img/tempo+zeon.png' ); ?>" alt="<?php echo esc_attr( tempo_core::zeon( 'description' ) ); ?>" style="margin: 0px auto; display: block; max-width: 100%;"/>
</a>
	...
	<table class="tempo-features-diff">
		<tbody>
			<tr>
				...
				<th class="tempo-premium"><?php _e( 'Tempo Premium', 'tempo' ); ?>
					<div>
			...
			<tr>
				<td class="tempo-feature"><?php _e( 'Plugin Easy Google Fonts ( support )', 'tempo' ); ?></td>
				<td class="tempo-free"><i class="tempo-icon-cancel-circled-2"></i></td>
				<td class="tempo-free"><?php _e( 'FULL ( ~ 25 Custom Controlls )', 'tempo' ); ?></td>
			</tr>
